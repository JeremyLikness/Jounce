...
namespace Workflow
{
    ...
    public partial class MainPage
    {
        ...
        private IEnumerable<IWorkflow> Workflow()
        {
            ...
            yield return new WorkflowBackgroundWorker(BackgroundWork, BackgroundProgress);
        ...
        private void BackgroundProgress(BackgroundWorker arg1, ProgressChangedEventArgs arg2)
        {
        ...
        private static void BackgroundWork(BackgroundWorker obj)
        {
